...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>请输入图片地址</b></p><p>你也可以添加一个标题,它将会显示在工具提示。</p><p>例如:<br />http.cssjser.com/images/cloud1.jpg   \"前端开发\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>请输入网站地址.</b></p><p>你也可以添加一个标题,它将会显示在工具提示。</p><p>例如:<br />http://cssjser.com/   \"前端开发\"</p>";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			boldButton.title = "加粗 <strong> Ctrl+B";
			boldButton.textOp = command.doBold;
			setupButton(boldButton, true);
            var boldIcon=document.createElement('i');
            boldIcon.className='icon-bold';
			...
			italicButton.title = "倾斜 <em> Ctrl+I";
			italicButton.XShift = "-20px";
			italicButton.textOp = command.doItalic;
			setupButton(italicButton, true);
            var italicIcon=document.createElement('i');
            italicIcon.className='icon-italic';
			...
			quoteButton.title = "引用 <blockquote> Ctrl+Q";
			quoteButton.XShift = "-60px";
			quoteButton.textOp = command.doBlockquote;
			setupButton(quoteButton, true);
            var quoteIcon=document.createElement('i');
            quoteIcon.className='icon-quote-left';
			...
			codeButton.title = "代码 <pre><code> Ctrl+K";
			...
			imageButton.title = "图片 <img> Ctrl+G";
            ...
            imgIcon.className='icon-picture';
            imageButton.appendChild(imgIcon);
			...
			olistButton.title = "有序列表 <ol> Ctrl+O";
			olistButton.XShift = "-120px";
			olistButton.textOp = function(chunk, postProcessing, useDefaultText){
				command.doList(chunk, postProcessing, true, useDefaultText);
			};
			setupButton(olistButton, true);
            var olistIcon=document.createElement('i');
            olistIcon.className='icon-list-ol';
            olistButton.appendChild(olistIcon);
			buttonRow.appendChild(olistButton);
			
			var ulistButton = document.createElement("li");
			ulistButton.className = "wmd-button";
			ulistButton.id = "wmd-ulist-button";
			ulistButton.title = "无序列表 <ul> Ctrl+U";
			ulistButton.XShift = "-140px";
			ulistButton.textOp = function(chunk, postProcessing, useDefaultText){
				command.doList(chunk, postProcessing, false, useDefaultText);
			};
			setupButton(ulistButton, true);
            var ulistIcon=document.createElement('i');
            ulistIcon.className='icon-list-ul';
            ulistButton.appendChild(ulistIcon);
			buttonRow.appendChild(ulistButton);
			
			var headingButton = document.createElement("li");
			headingButton.className = "wmd-button";
			headingButton.id = "wmd-heading-button";
			headingButton.title = "标题 <h1>/<h2> Ctrl+H";
			headingButton.XShift = "-160px";
			headingButton.textOp = command.doHeading;
			setupButton(headingButton, true);
            var headIcon=document.createElement('i');
            headIcon.className='icon-text-width';
            headingButton.appendChild(headIcon);
			buttonRow.appendChild(headingButton); 
			
			var hrButton = document.createElement("li");
			hrButton.className = "wmd-button";
			hrButton.id = "wmd-hr-button";
			hrButton.title = "换行符 <hr> Ctrl+R";
			hrButton.XShift = "-180px";
			hrButton.textOp = command.doHorizontalRule;
			setupButton(hrButton, true);
            var hrIcon=document.createElement('i');
            hrIcon.className='icon-minus';
            hrButton.appendChild(hrIcon);
            ...
            undoIcon.className='icon-mail-reply';
			...
			redoButton.title = "还原 - Ctrl+Y";
			if (/win/.test(nav.platform.toLowerCase())) {
				redoButton.title = "还原 - Ctrl+Y";
			}
			else {
				// mac and other non-Windows platforms
				redoButton.title = "还原 - Ctrl+Shift+Z";
			}
            ...
            redoIcon.className='icon-mail-forward';
